...
const subcategories = [
  { 
    ...
    description: 'All home utility products'
  },
  { 
    id: 'bath-laundry', 
    name: 'Bath & Laundry', 
    icon: '/images/category/bath-laundry.png',
    description: 'Bathroom and laundry essentials'
  },
  { 
    id: 'furnishing', 
    name: 'Furnishing', 
    icon: '/images/category/furnishing.png',
    description: 'Home furnishing and decor'
  },
  { 
    id: 'pooja-festive', 
    name: 'Pooja & Festive', 
    icon: '/images/category/pooja-festive.png',
    description: 'Religious and festive items'
  },
  { 
    id: 'party-needs', 
    name: 'Party Needs', 
    icon: '/images/category/party-needs.png',
...
const sampleProducts = [
  { id: 1, name: 'Liquid Detergent', price: '₹300', unit: '2L', category: 'bath-laundry', image: '/images/products/detergent.jpg' },
  { id: 2, name: 'Cotton Bedsheet', price: '₹800', unit: 'King Size', category: 'furnishing', image: '/images/products/bedsheet.jpg' },
  { id: 3, name: 'Pooja Thali Set', price: '₹450', unit: '1 pc', category: 'pooja-festive', image: '/images/products/pooja-thali.jpg' },
  { id: 4, name: 'Party Balloons', price: '₹150', unit: '50 pcs', category: 'party-needs', image: '/images/products/balloons.jpg' },
  { id: 5, name: 'Bath Towel Set', price: '₹600', unit: '2 pcs', category: 'bath-laundry', image: '/images/products/towel-set.jpg' },
  { id: 6, name: 'Curtains', price: '₹1200', unit: 'Pair', category: 'furnishing', image: '/images/products/curtains.jpg' },
  { id: 7, name: 'Diya Set', price: '₹200', unit: '12 pcs', category: 'pooja-festive', image: '/images/products/diya-set.jpg' },
  { id: 8, name: 'Paper Plates', price: '₹180', unit: '50 pcs', category: 'party-needs', image: '/images/products/paper-plates.jpg' },
  { id: 9, name: 'Bath Mat', price: '₹350', unit: '1 pc', category: 'bath-laundry', image: '/images/products/bath-mat.jpg' },
  { id: 10, name: 'Cushion Covers', price: '₹250', unit: '2 pcs', category: 'furnishing', image: '/images/products/cushion-covers.jpg' },
];
      ...
      <div className="py-4 bg-light">
        <Container>
          ...
          <Breadcrumb className="mb-4">
            ...
            <Breadcrumb.Item active>Home Utility</Breadcrumb.Item>
